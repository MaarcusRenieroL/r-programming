...
#Method 2:
setwd('C:\\Maarcus\\Courses\\Udemy\\R Programming\\Module 5')
getwd()
...
data[3, 3]
data[3, "Birth.rate"]
data$Internet.users #same as
data$Internet.users[2]
data[, "Internet.users"] #this
...
qplot(data = data, x = Income.Group, y = Birth.rate, size=I(2), color=I("blue"))
...
qplot(data = merged, x = Internet.users, y = Birth.rate, color = Region, shape = Income.Group, size = I(3), alpha = I(0.6), main = "Birth Rate vs. Internet Users by Income Group")
...
#Title
qplot(data = merged, x = Internet.users, y = Birth.rate, color = Region, size = I(5), shape = I(23), alpha = I(0.6), main = "Birth Rate vs Internet Users")
